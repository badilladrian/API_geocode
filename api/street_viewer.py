...
class StreetViewer(object):
    def __init__(self, api_key='AIzaSyCL3WravFN_wNUfKU6cC4QRWAOzfbfo49g', size="640x640",
                 folder_directory='./streetviews/', verbose=True, location = ''):
        """
    ...
    def get_meta(self):
        ...
        self.id_data = (uuid.uuid1())
        self.meta_path = "meta_{}.json".format(self.id_data)
    ...
    def get_pic(self):
        ...
        self.pic_path = "pic_{}.jpg".format(self.id_data)
        self.header_path = "header_{}.json".format(self.id_data)
